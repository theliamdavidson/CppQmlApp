                    ...
                    Item {
                      ...
                      Row{
                          ...
                          RoundButton {
                              ...
                              highlighted: true
                              onClicked: {
                                 model.remove(parseInt(listInt));
                                  // doesn't work yet
                                  // not a large concern as release version will
                                  // include a database, so this is a flare thing
                                 listInt = listInt - 1
                              }
                          }
                      }
                    ...
                    RoundButton {
                        ...
                        onClicked: {
                            if ((firstNameField.text && lastNameField.text) !== ""){
                                    ...
                                    firstNameField.text = ""
                                    lastNameField.text = ""
                                    // switch to this for later revisions https://www.linkedin.com/pulse/qt-sql-model-qml-salvatore-cristiano-chieppa
                                    scanOptions.open()
                                    popupAdd.close()
                            }
                            else{
